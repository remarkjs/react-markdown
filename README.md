...
###### General  
`children`  
Content of the text snippet to be rendered (passed to all renderers except `parsedHtml` and `definition`)

###### list

* **ordered**  
Use `<ol>` instead of `<ul>` for the list
* **start**  
...
* **checked**  
Renders a checked checkbox at the beginning of the list item

###### heading

* **level**  
The level of heading between 1-6

###### code

* **language**  
The language specified for the codeblock

###### html

* **skipHtml**  
if this prop is `true` HTML code will be ignored
* **isBlock**  
if this prop is `true` the HTML code will be rendered in a `div` tag
