 ...
 * @typedef {import('./custom-types').ReactMarkdownProps} ReactMarkdownProps
 *
 * @typedef Raw
 * @property {'raw'} type
 ...
 *
 * @typedef {Partial<Omit<import("./custom-types").NormalComponents, keyof SpecialComponents> & SpecialComponents>} Components
 *
 * @typedef Options
